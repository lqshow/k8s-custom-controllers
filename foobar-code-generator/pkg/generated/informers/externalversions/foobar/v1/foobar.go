...
import (
	...
	v1 "github.com/lqshow/k8s-custom-controllers/foobar-code-generator/pkg/generated/listers/foobar/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.K8sV1().FooBars(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.K8sV1().FooBars(namespace).Watch(options)
			},
		},
		&foobarv1.FooBar{},
		resyncPeriod,
...
func (f *fooBarInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&foobarv1.FooBar{}, f.defaultInformer)
}
