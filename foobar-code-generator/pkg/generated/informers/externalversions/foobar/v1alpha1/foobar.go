...
import (
	...
	foobarv1alpha1 "github.com/lqshow/k8s-custom-controllers/foobar-code-generator/pkg/apis/foobar/v1alpha1"
	...
	v1alpha1 "github.com/lqshow/k8s-custom-controllers/foobar-code-generator/pkg/generated/listers/foobar/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecrdV1alpha1().FooBars(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecrdV1alpha1().FooBars(namespace).Watch(options)
			},
		},
		&foobarv1alpha1.FooBar{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooBarInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&foobarv1alpha1.FooBar{}, f.defaultInformer)
}
